/**
 * @file main.c
 * @brief Main entry point for LED blinking and stepper motor control application w/ LoRa
 * @version 1.0
 * @date 2025-06-15
 * @author Kevin Thomas
 *
 * This is the main application entry point for a Raspberry Pi Pico project that
 * combines LED blinking with 4-channel stepper motor control using ULN2003 drivers w/ LoRa.
